...
Served over [FastAPI!](https://fastapi.tiangolo.com)
...
2. Access the feed using the URL: `http://<host>:8000/`
...
1. Daily index at previous close: `http://<host>:8000/daily`

2. Hourly index (rounded down): `http://<host>:8000/hourly`

3. Hourly index (if different from previous close, i.e. when markets are open): `http://<host>:8000/hourly_open`
